...
private object AppDataStoreHolder {
    ...
    fun get(context: Context): DataStore<Preferences> {
        ...
        return instance ?: synchronized(this) {
            instance ?: createDataStore(appContext).also { instance = it }
        }
    }
}

private class AndroidAppStorage(
...
@Composable
actual fun rememberAppStorage(): AppStorage {
    val context = LocalContext.current
    return remember(context) { AndroidAppStorage(AppDataStoreHolder.get(context)) }
}
